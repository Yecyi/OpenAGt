      ...
      <div className="ss" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className="ss-body">
                ...
                <div className="ss-segs ss-theme">
                  <button className={`ss-seg ${theme === "light" ? "on" : ""}`} onClick={() => onTheme("light")}>
                    <svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
                      ...
                      <line x1="11.1" y1="11.1" x2="12.5" y2="12.5" />
                      <line x1="3.5" y1="12.5" x2="4.9" y2="11.1" />
                      <line x1="11.1" y1="4.9" x2="12.5" y2="3.5" />
                    </svg>
                    <span>Day</span>
                  </button>
            ...
            <div className="ss-row">
              ...
              <div className="ss-v">
                <div className="ss-segs">
                  <button
                    className={`ss-seg ${(tweaks.density || "comfortable") === "comfortable" ? "on" : ""}`}
                    onClick={() => setTweak && setTweak("density", "comfortable")}
                  >
                    Comfortable
                  </button>
                  <button
                    className={`ss-seg ${tweaks.density === "compact" ? "on" : ""}`}
                    onClick={() => setTweak && setTweak("density", "compact")}
                  >
                    Compact
                  </button>
                </div>
          ...
          <section className="ss-section">
            ...
            <div className="ss-row">
              ...
              <div className="ss-v">
                <SsToggle
                  on={tweaks.notifyApprovals !== false}
                  onChange={(v) => setTweak && setTweak("notifyApprovals", v)}
                />
              </div>
            </div>
            <div className="ss-row">
              ...
              <div className="ss-v">
                <SsToggle
                  on={tweaks.notifyMission !== false}
                  onChange={(v) => setTweak && setTweak("notifyMission", v)}
                />
              </div>
            </div>
          </section>
          ...
          <section className="ss-section">
            ...
            <div className="ss-row">
              <div className="ss-k">
                ...
                <div className="ss-kd">
                  Local-only diagnostic events. Nothing leaves this machine without explicit upload.
                </div>
              </div>
              <div className="ss-v">
          ...
          <section className="ss-section">
            ...
            <div className="ss-row">
              ...
              <div className="ss-v">
                <select
                  className="ss-select"
                  value={tweaks.editor || "vscode"}
                  onChange={(e) => setTweak && setTweak("editor", e.target.value)}
                >
        ...
        <footer className="ss-foot">
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {onAdvanced && (
              <button className="mc-btn ghost" onClick={onAdvanced}>

...
const REVIEWERS = ["claude-haiku-4-5", "claude-sonnet-4.5", "claude-opus-4", "gpt-4o-mini", "off"]
    ...
    <div className="cs-pop" onMouseDown={(e) => e.stopPropagation()}>
      ...
      <div className="cs-body">
          ...
          <div className="cs-v">
            <div className="cs-segs">
              {BUDGETS.map((b) => (
                <button
                  key={b.id}
                  className={`cs-seg ${settings.budget === b.id ? "on" : ""}`}
        ...
        <div className="cs-row">
          ...
          <div className="cs-v">
            <button
              className={`cs-toggle ${settings.autoContinue ? "on" : ""}`}
              onClick={() => update("autoContinue", !settings.autoContinue)}
            >
        ...
        <div className="cs-row">
          ...
          <div className="cs-v cs-numrow">
            <Stepper
              value={settings.maxWall}
              onChange={(v) => update("maxWall", v)}
              min={5}
              max={240}
              step={5}
              unit="min"
      ...
      <footer className="cs-foot">
        <button className="mc-btn ghost" onClick={() => setSettings(DEFAULT_COMPOSER_SETTINGS)}>
          Reset
        </button>

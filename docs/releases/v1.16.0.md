...
- Release automation:
  ...
  - unsigned Windows assets are RC-safe; signed GA requires signing configuration
...
- Windows SmartScreen may warn on unsigned RC assets with `Unknown publisher`.
- Signed GA requires configured Windows signing secrets.

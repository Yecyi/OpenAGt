...
- Release-critical split suites covering CLI smoke, session, tool, agent, security, installation, MCP, provider, PTY, file, snapshot, storage, and supporting runtime modules pass on the release branch

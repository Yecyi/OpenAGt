...
| **妯″潡鍖栬璁?* | 377 鏂囦欢锛寏15 椤跺眰妯″潡 | 绠€娲佸彲缁存姢 |
| **SQLite 鎸佷箙鍖?* | Drizzle ORM + SQLite | 缁撴瀯鍖栨暟鎹鐞?|
| **鎶€鑳界郴缁?* | `@openagt/skill` 宸ヤ綔鍖?| 鍙墿灞曟妧鑳戒綋绯?|
...
| **Bun 杩愯鏃?* | 蹇€熷惎鍔?| Hermes Python 杈冩參 |
...
*鎶ュ憡鐢熸垚鏃堕棿锛?026-04-19*
*鍩轰簬锛歄penAGt v1.14.17銆丆odex (Rust monorepo)銆丠ermes Agent (Python)*

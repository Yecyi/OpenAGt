import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@openagt/sdk/v2"
import { SessionTurn } from "@openagt/ui/session-turn"
import { SessionReview } from "@openagt/ui/session-review"
import { DataProvider } from "@openagt/ui/context"
import { FileComponentProvider } from "@openagt/ui/context/file"
import { WorkerPoolProvider } from "@openagt/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openagt/ui/logo"
import { IconButton } from "@openagt/ui/icon-button"
import { ProviderIcon } from "@openagt/ui/provider-icon"
import { iife } from "@openagt/shared/util/iife"
...
import { Tabs } from "@openagt/ui/tabs"
import { MessageNav } from "@openagt/ui/message-nav"
import { FileSSR } from "@openagt/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openagt/ui/pierre/worker").then((m) => ({

...
function ErrorInfo(props) {
    ...
    return (<span class="dev-overlay-error-info">
...
function StackFramesContent(props) {
    ...
    return (<div class="dev-overlay-stack-frames-content">
      ...
      <Select class="dev-overlay-stack-frames" value={selectedFrame()} onChange={setSelectedFrame}>
        <For each={stackframes}>
          {current => (<ErrorBoundary fallback={<div class="dev-overlay-stack-frame">
              ...
              {(() => {
                ...
                return (<Suspense>
                    <Show when={data()} keyed>
                      {source => (<SelectOption class="dev-overlay-stack-frame" value={current}>
                          <span class="dev-overlay-stack-frame-function">
          ...
          <DialogPanel ref={setPanel} class="dev-overlay-panel-container">
            <div class="dev-overlay-panel">
              ...
              <Show when={props.errors[truncated() - 1]} keyed>
                {current => (<div class="dev-overlay-content">

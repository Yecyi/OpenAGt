      ...
      callers: [
        {
          ...
          getRuntimeCode: () =>
            `import { createServerReference } from "${runtimeImportPath(new URL("../server/server-runtime", import.meta.url))}"`,
        ...
        },
        {
          ...
          getRuntimeCode: () =>
            `import { createServerReference } from '${runtimeImportPath(new URL("../server/server-fns-runtime", import.meta.url))}'`,

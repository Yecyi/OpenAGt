...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new OpenagtClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global OpenAGt configuration settings and preferences.
   */
   ...
   *
   * Update global OpenAGt configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the OpenAGt server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the OpenAGt system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all OpenAGt instances, releasing all resources.
   */
   ...
   * Upgrade openagt
   *
   * Upgrade openagt to the specified version or latest if not specified.
   */
...
export class OpenagtClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<OpenagtClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    OpenagtClient.__registry.set(this, args?.key)
  }

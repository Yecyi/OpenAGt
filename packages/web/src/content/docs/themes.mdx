...
With OpenAGt you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, OpenAGt uses our own `opencode` theme.
...
OpenAGt comes with several built-in themes.
...
- Want OpenAGt to match their terminal's appearance
...
OpenAGt supports a flexible JSON-based theme system that allows users to create and customize themes easily.

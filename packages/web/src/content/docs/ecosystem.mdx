---
title: Ecosystem
description: Projects and integrations built with OpenAGt.
---

A collection of community projects built on OpenAGt.

:::note
Want to add your OpenAGt related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run OpenAGt sessions in isolated Daytona sandboxes with git sync and live previews |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track OpenAGt usage with Wakatime                                                                |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for OpenAGt sessions                                      |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on OpenAGt context                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow OpenAGt agents to lazy load prompts on demand with skill discovery and injection           |
...
| [micode](https://github.com/vtemian/micode)                                                        | Structured Brainstorm 鈫?Plan 鈫?Implement workflow with session continuity                         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for OpenAGt 鈥?know when tasks complete                                   |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | Bundled multi-agent orchestration harness 鈥?16 components, one install                            |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for OpenAGt                                                          |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control OpenAGt sessions, built on the SDK       |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building OpenAGt plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for opencode - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using OpenAGt via @openagt/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for OpenAGt             |
| [OpenAGt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds OpenAGt in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by OpenAGt |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | OpenAGt extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for OpenAGt          |

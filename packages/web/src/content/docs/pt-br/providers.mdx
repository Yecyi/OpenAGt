...
OpenAGt Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o OpenAGt Zen.
:::

1. Execute o comando `/connect` no TUI, selecione `OpenAGt Zen` e acesse [github.com/Yecyi/OpenAGt/zen](https://github.com/Yecyi/OpenAGt/zen).
...
OpenAGt Go é um plano de assinatura de baixo custo que fornece acesso confiável a modelos de codificação abertos populares fornecidos pela equipe do opencode que foram
testados e verificados para funcionar bem com o opencode.

1. Execute o comando `/connect` no TUI, selecione `OpenAGt Go` e acesse [github.com/Yecyi/OpenAGt/zen](https://github.com/Yecyi/OpenAGt/zen).
...
OpenAGt Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>OpenAGt Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **OpenAGt Zen**.

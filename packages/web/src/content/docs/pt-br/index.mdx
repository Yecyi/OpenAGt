...
- **Usando Homebrew no macOS e Linux**
  ...
  > Recomendamos usar o tap do opencode para as versões mais atualizadas. A fórmula oficial `brew install openagt` é mantida pela equipe do Homebrew e é atualizada com menos frequência.
...
Você também pode baixar o binário na seção [Releases](https://github.com/Yecyi/OpenAGt/releases).
...
Se você é novo no uso de provedores de LLM, recomendamos usar o [OpenAGt Zen](/docs/zen).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do opencode.

1. Execute o comando `/connect` no TUI, selecione opencode e acesse [github.com/Yecyi/OpenAGt/auth](https://github.com/Yecyi/OpenAGt/auth).
...
Aqui está uma [conversa de exemplo](https://github.com/Yecyi/OpenAGt/s/4XP1fce5) com o opencode.

---
title: TUI
description: Using the OpenAGt terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAGt provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running OpenAGt starts the TUI for the current directory.
...
When using the OpenAGt TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to OpenAGt. Allows you to select from available providers and add their API keys.

---
title: TUI
description: Using the OpenAG terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAG provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running OpenAG starts the TUI for the current directory.

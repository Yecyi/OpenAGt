---
title: Ecosistema
description: Progetti e integrazioni costruiti con OpenAGt.
---

Una raccolta di progetti della comunit脿 costruiti su OpenAGt.

:::note
Vuoi aggiungere il tuo progetto legato a OpenAGt a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-opencode](https://github.com/awesome-opencode/awesome-opencode) e [opencode.cafe](https://opencode.cafe), una comunit脿 che aggrega ecosistema e community.
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni OpenAGt in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-google-antigravity-auth](https://github.com/shekohex/opencode-google-antigravity-auth)   | Plugin OAuth Google Antigravity, con supporto a Google Search e gestione API pi霉 robusta          |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di OpenAGt con Wakatime                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni OpenAGt                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto OpenAGt                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti OpenAGt di caricare prompt al bisogno con discovery e injection di skill    |
...
| [micode](https://github.com/vtemian/micode)                                                        | Workflow strutturato Brainstorm 鈫?Plan 鈫?Implement con continuit脿 di sessione                     |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per OpenAGt: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per OpenAGt                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni OpenAGt, costruito sull'SDK    |
...
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per OpenAGt su Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin OpenAGt                               |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per opencode: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare OpenAGt tramite @openagt/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per OpenAGt                   |
| [OpenAGt-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra OpenAGt nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da OpenAGt      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni OpenAGt con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per OpenAGt                |

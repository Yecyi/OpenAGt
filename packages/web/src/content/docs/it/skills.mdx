...
Le skill degli agenti permettono a OpenAGt di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
OpenAGt cerca in queste posizioni:
...
Per i percorsi locali al progetto, OpenAGt risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
OpenAGt elenca le skill disponibili nella descrizione dello strumento `skill`.

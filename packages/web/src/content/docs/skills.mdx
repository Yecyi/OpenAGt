...
Agent skills let OpenAGt discover reusable instructions from your repo or home directory.
...
OpenAGt searches these locations:
...
For project-local paths, OpenAGt walks up from your current working directory until it reaches the git worktree.
...
OpenAGt lists available skills in the `skill` tool description.

...
Dostępny serwery MCP w [opencode Config](https://github.com/Yecyi/OpenAGt/docs/config/) w `mcp`. Dodaj każdy MCP z unikalną nazwą. Możesz zgłosić się do tego MCP po nazwie, pytając LLM.

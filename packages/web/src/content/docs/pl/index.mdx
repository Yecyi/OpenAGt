...
- **Korzystanie z Homebrew na macOS i Linux**
  ...
  > W celu uzyskania najbardziej aktualnej wersji zalecamy korzystanie z opencode. Oficjalna formuła `brew install openagt` jest utrzymywana przez zespół Homebrew i jest aktualizowana.
...
Możesz także pobrać plik binarny z [Releases](https://github.com/Yecyi/OpenAGt/releases).
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [OpenAGt Zen](/docs/zen).
Aby uzyskać dostęp do wyselekcjonowanej listy modeli, które zostały zatwierdzone i zweryfikowane przez zespół opencode.

1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [github.com/Yecyi/OpenAGt/auth](https://github.com/Yecyi/OpenAGt/auth).
...
Oto [przykładowa rozmowa](https://github.com/Yecyi/OpenAGt/s/4XP1fce5) z opencode.

---
title: LSP Servers
description: OpenAGt integrates with your LSP servers.
---

OpenAGt integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

OpenAGt comes with several built-in LSP servers for popular languages:

...
เครื่องมืออนุญาตให้ LLM ดำเนินการในโค้ดเบสของคุณ OpenAGt มาพร้อมกับชุดเครื่องมือในตัว แต่คุณสามารถขยายได้ด้วย [เครื่องมือที่กำหนดเอง](/docs/custom-tools) หรือ [MCP เซิร์ฟเวอร์](/docs/mcp-servers)
...
นี่คือเครื่องมือในตัวทั้งหมดที่มีอยู่ใน OpenAGt
...
:::note
เครื่องมือนี้ใช้ได้เฉพาะเมื่อใช้ผู้ให้บริการ OpenAGt หรือเมื่อตัวแปรสภาพแวดล้อม `OPENCODE_ENABLE_EXA` ถูกตั้งค่าเป็นค่าความจริง (เช่น `true` หรือ `1`)

หากต้องการเปิดใช้งานเมื่อเปิดตัว OpenAGt:

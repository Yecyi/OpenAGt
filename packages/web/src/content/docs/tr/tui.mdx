---
title: TUI
description: OpenAGt terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAGt, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

OpenAGt'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
OpenAGt TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
OpenAGt'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
OpenAGt'dan çıkar. _Takma adlar_: `/quit`, `/q`

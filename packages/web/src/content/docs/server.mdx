---
title: Server
description: Interact with openAG server over HTTP.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The `openag serve` command runs a headless HTTP server that exposes an OpenAPI endpoint that an openAG client can use.
...
:::tip
Use the openag server to interact with openag programmatically.
:::

This architecture lets openag support multiple clients and allows you to interact with openag programmatically.
...
The openag server exposes the following APIs.

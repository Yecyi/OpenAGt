...
تتيح مهارات الوكيل لـ OpenAGt اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج OpenAGt صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض OpenAGt المهارات المتاحة في وصف أداة `skill`.

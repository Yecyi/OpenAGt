...
مع OpenAGt يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم OpenAGt سمتنا `opencode`.
...
يأتي OpenAGt مع عدة سمات مدمجة.
...
- يريدون أن يطابق OpenAGt مظهر terminal لديهم
...
يدعم OpenAGt نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.

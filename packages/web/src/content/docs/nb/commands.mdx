...
Du kan legge til egendefinerte kommandoer gjennom OpenAGt-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenAGt [config](/docs/config):
...
OpenAGt inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

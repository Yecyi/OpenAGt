---
title: TUI
description: Usando la interfaz de usuario del terminal OpenAGt.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAGt proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OpenAGt se inicia TUI para el directorio actual.
...
Cuando utilice OpenAGt TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OpenAGt. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de OpenAGt. _Alias_: `/quit`, `/q`

...
Las habilidades del agente permiten a OpenAGt descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
OpenAGt busca estas ubicaciones:
...
Para las rutas locales del proyecto, OpenAGt sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
OpenAGt enumera las habilidades disponibles en la descripción de la herramienta `skill`.

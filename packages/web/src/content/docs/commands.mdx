...
You can add custom commands through the OpenAGt config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenAGt [config](/docs/config):

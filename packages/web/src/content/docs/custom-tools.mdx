...
Tools are defined as **TypeScript** or **JavaScript** files. However, the tool definition can invoke scripts written in **any language** 鈥?TypeScript or JavaScript is only used for the tool definition itself.

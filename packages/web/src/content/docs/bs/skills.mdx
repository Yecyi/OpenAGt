...
Agent skills omogucavaju OpenAGt da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
OpenAGt pretrazuje ove lokacije:
...
Za projektne lokalne putanje, OpenAGt ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
OpenAGt navodi dostupne skills u opisu `skill` alata.

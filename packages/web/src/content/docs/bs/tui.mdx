---
title: TUI
description: Korištenje korisničkog interfejsa OpenAGt terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenAGt pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenAGt pokreće TUI za trenutni direktorij.
...
Kada koristite OpenAGt TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenAGt. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenAGt. _Aliases_: `/quit`, `/q`

---
title: LSP serveri
description: OpenAGt se integriše sa vašim LSP serverima.
---

OpenAGt se integriše sa vašim Language Server Protocol (LSP) serverima kako bi pomogao LLM-u u interakciji s kodnom bazom. Koristi dijagnostiku za slanje povratnih informacija modelu.

## Ugrađeni

OpenAGt dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:

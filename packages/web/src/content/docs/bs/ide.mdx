---
title: IDE
description: Ekstenzija OpenAGt za VS Code, Cursor i druge IDE
---

OpenAGt se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `opencode` u terminalu da započnete.

---

## Korištenje

- **Brzo pokretanje**: Koristite `Cmd+Esc` (Mac) ili `Ctrl+Esc` (Windows/Linux) da otvorite OpenAGt u prikazu podijeljenog terminala ili fokusirajte postojeću terminalsku sesiju ako je već pokrenuta.
- **Nova sesija**: Koristite `Cmd+Shift+Esc` (Mac) ili `Ctrl+Shift+Esc` (Windows/Linux) da započnete novu OpenAGt terminalsku sesiju, čak i ako je ona već otvorena. Takođe možete kliknuti na dugme OpenAGt u korisničkom sučelju.
- **Svijest o kontekstu**: Automatski dijelite svoj trenutni odabir ili karticu s OpenAGt.
...
Da biste instalirali OpenAGt na VS Code i popularne viljuške kao što su Cursor, Windsurf, VSCodium:
...
Potražite **OpenAGt** na Extension Marketplaceu i kliknite na **Instaliraj**.

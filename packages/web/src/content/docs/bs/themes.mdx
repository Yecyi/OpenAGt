...
U OpenAGt mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, OpenAGt koristi nasu `opencode` temu.
...
OpenAGt dolazi sa vise ugradenih tema.
...
- Zele da OpenAGt odgovara izgledu njihovog terminala
...
OpenAGt podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.

...
Agent Skills erlauben OpenAGt, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
OpenAGt sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft OpenAGt vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
OpenAGt listet verfuegbare Skills in der Beschreibung des `skill`-Tools.

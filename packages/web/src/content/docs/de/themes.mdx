...
Mit OpenAGt kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet OpenAGt das `opencode`-Theme.
...
OpenAGt liefert mehrere eingebaute Themes mit.
...
- OpenAGt optisch ans Terminal anpassen wollen
...
OpenAGt unterstuetzt ein flexibles JSON-basiertes Theme-System.

...
Agentferdigheter lar OpenAGt oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
OpenAGt søker etter disse stedene:
...
For prosjektlokale stier går OpenAGt opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OpenAGt viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.

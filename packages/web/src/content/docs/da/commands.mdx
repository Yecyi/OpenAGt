...
Du kan tilføje brugerdefinerede kommandoer gennem OpenAGt-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din OpenAGt [config](/docs/config):

...
[`/tui`](#tui) endpointet kan bruges til at køre TUI gennem serveren. Du kan for eksempel forududfylde eller køre en forespørgsel. Denne opsætning bruges af OpenAGt [IDE](/docs/ide) plugins.
...
OpenAGt-serveren viser følgende API'er.

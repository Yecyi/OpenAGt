---
title: Serveurs LSP
description: OpenAGt s'intègre à vos serveurs LSP.
---

OpenAGt s'intègre via le protocole LSP (Language Server Protocol) pour aider le LLM à interagir avec votre base de code. Il utilise des diagnostics pour fournir des commentaires au LLM.

---

## Serveurs intégrés

OpenAGt est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :

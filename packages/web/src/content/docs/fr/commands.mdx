...
Vous pouvez ajouter des commandes personnalisées via la configuration OpenAGt ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre OpenAGt [config](/docs/config) :

...
Les compétences d'agent permettent à OpenAGt de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
OpenAGt recherche ces emplacements :
...
Pour les chemins locaux du projet, OpenAGt remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
OpenAGt répertorie les compétences disponibles dans la description de l'outil `skill`.

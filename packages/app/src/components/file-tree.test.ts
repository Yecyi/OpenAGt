...
beforeAll(async () => {
  ...
  mock.module("@openagt/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openagt/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openagt/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openagt/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

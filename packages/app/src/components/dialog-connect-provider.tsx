import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@openagt/sdk/v2/client"
...
import { List, type ListRef } from "@openagt/ui/list"
        ...
        <Switch>
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openAGZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openAGZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.openAGZen.visit.prefix")}
                <Link href="https://openAG.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.openAGZen.visit.link")}
                </Link>
                {language.t("provider.connect.openAGZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>

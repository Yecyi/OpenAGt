...
import { base64Encode } from "@openagt/shared/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@openagt/ui/resize-handle"
...
import { Session, type Message } from "@openagt/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@openagt/ui/toast"
...
import { useTheme, type ColorScheme } from "@openagt/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://openAG.ai/desktop-feedback")}
      renderPanel={() =>

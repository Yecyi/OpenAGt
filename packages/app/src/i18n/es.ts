export const dict = {
  ...
  "dialog.provider.openAG.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.openAG.tagline": "Modelos optimizados y fiables",
  "dialog.provider.openAGGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.openAGZen.visit.prefix": "Visita ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.plugins.empty": "Plugins configurados en openAG.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (openAG.json)",

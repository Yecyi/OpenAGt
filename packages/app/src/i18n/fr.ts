export const dict = {
  ...
  "dialog.provider.openAG.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.openAG.tagline": "Modèles optimisés et fiables",
  "dialog.provider.openAGGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.openAGZen.visit.prefix": "Visitez ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans openAG.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (openAG.json) pour les noms de fournisseur/modèle",

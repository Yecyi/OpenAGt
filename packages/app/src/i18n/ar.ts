export const dict = {
  ...
  "dialog.provider.openAG.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.openAG.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.openAGGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.openAGZen.visit.prefix": "قم بزيارة ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في openAG.json",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (openAG.json)",

export const dict = {
  ...
  "dialog.provider.openAG.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.openAG.tagline": "Надежные оптимизированные модели",
  "dialog.provider.openAGGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.openAGZen.visit.prefix": "Посетите ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.plugins.empty": "Плагины настроены в openAG.json",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (openAG.json)",

export const dict = {
  ...
  "dialog.provider.openAG.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.openAG.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.openAGGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.openAGZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.openAGZen.visit.prefix": " ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "openAG.jsonで設定されたプラグイン",
  ...
  "error.chain.checkConfig": "config (openAG.json) のプロバイダー/モデル名を確認してください",

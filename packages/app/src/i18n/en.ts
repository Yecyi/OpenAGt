export const dict = {
  ...
  "dialog.provider.openAG.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.openAG.tagline": "Reliable optimized models",
  "dialog.provider.openAGGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenAG",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenAG.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.openAGZen.line1":
    "OpenAG Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.openAGZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.openAGZen.visit.prefix": "Visit ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenAG.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenAG.",
  ...
  "dialog.plugins.empty": "Plugins configured in openAG.json",
  ...
  "dialog.server.description": "Switch which OpenAG server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenAG ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenAG team",
  ...
  "error.chain.checkConfig": "Check your config (openAG.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenAG does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenAG includes free models so you can start immediately.",
  ...
  "app.name.desktop": "OpenAG Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenAG server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenAG",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenAG looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenAG follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenAG is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenAG launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenAG.",

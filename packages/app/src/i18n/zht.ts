...
export const dict = {
  ...
  "dialog.provider.openAG.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.openAG.tagline": "可靠的優化模型",
  "dialog.provider.openAGGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.openAGZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.openAGZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.openAGZen.visit.prefix": "造訪 ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 openAG.json 中設定的外掛程式",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (openAG.json) 中的 provider/model 名稱",

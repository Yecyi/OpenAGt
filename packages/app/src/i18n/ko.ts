export const dict = {
  ...
  "dialog.provider.openAG.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.openAG.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.openAGGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.openAGZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.openAGZen.visit.prefix": "다음 ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "openAG.json에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(openAG.json)의 공급자/모델 이름을 확인하세요",

export const dict = {
  ...
  "dialog.provider.openAG.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openAG.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openAGGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.openAGZen.visit.prefix": "Odwiedź ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openAG.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openAG.json) nazwy dostawców/modeli",

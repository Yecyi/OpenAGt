...
export const dict = {
  ...
  "dialog.provider.openAG.note": "使用 OpenAGt Zen 或 API 密钥连接",
  "dialog.provider.openAG.tagline": "可靠的优化模型",
  "dialog.provider.openAGGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.openAGZen.line1": "OpenAGt Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.openAGZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.openAGZen.visit.prefix": "访问 ",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 openAG.json 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (openAG.json) 中的 provider/model 名称",

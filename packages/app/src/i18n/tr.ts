...
export const dict = {
  ...
  "dialog.provider.openAG.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openAG.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openAGGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.openAGZen.visit.prefix": "",
  "provider.connect.openAGZen.visit.link": "openAG.ai/zen",
  "provider.connect.openAGZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "dialog.plugins.empty": "Eklentiler openAG.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openAG.json) sağlayıcı/model adlarını kontrol edin",

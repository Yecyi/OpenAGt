  ...
  Effect.gen(function* () {
    ...
    const describeTask = Effect.fn("ToolRegistry.describeTask")(function* (agent: Agent.Info) {
      ...
      return [
        ...
        "- Use task_get to read completed or partial task content; do not resume a completed task just to retrieve its output",
        "- Use task_list only for compact status overviews",
        ...
        "- If direct repository exploration is still needed after subagents return, use Glob/Grep/Read instead of Bash ls/dir/find/cat",
        "",
        description,
      ].join("\n")
    })

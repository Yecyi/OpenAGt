...
import { type ToolPart } from "@openagt/sdk/v2"
import { UI } from "../ui"
...
export function fallback(part: ToolPart) {
  const state = part.state
...
export function printToolPart(part: ToolPart) {
...
export function printTaskPart(part: ToolPart) {
  task(props<typeof TaskTool>(part))
}

export function printToolFailed(toolName: string) {
  inline({
    icon: "✗",

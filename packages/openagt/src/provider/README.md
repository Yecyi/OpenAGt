...
```typescript
const smallModelPriority = ["claude-haiku-4-5", "gemini-3-flash", "gpt-5-nano"]
```
...
```typescript
const model = yield * Provider.Service.getModel(ProviderID.make("anthropic"), ModelID.make("claude-sonnet-4"))

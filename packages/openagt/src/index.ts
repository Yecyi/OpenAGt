...
const cli = yargs(args)
  ...
  .scriptName(process.env.OPENAGT_LEGACY_COMMAND ? "opencode" : "openagt")
  .wrap(100)
  .help("help", "show help")
  .alias("help", "h")
  ...
  .middleware(async (opts) => {
    ...
    process.env.AGENT = "1"
    process.env.OPENAGT = "1"
    process.env.OPENAGT_PID = String(process.pid)
    process.env.OPENCODE = "1"
    process.env.OPENCODE_PID = String(process.pid)

    Log.Default.info("openagt", {

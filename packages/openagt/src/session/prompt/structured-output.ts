...
// Structured-output tool construction for JSON-schema final answers.
// This module builds the AI SDK tool only; it does not run model loops or retry validation.

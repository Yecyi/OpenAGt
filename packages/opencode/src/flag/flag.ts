...
export const Flag = {
  ...
  OPENCODE_SANDBOX_SEATBELT_HELPER: process.env["OPENCODE_SANDBOX_SEATBELT_HELPER"],
  OPENCODE_SANDBOX_WINDOWS_HELPER: process.env["OPENCODE_SANDBOX_WINDOWS_HELPER"],
  OPENCODE_SANDBOX_LANDLOCK_HELPER: process.env["OPENCODE_SANDBOX_LANDLOCK_HELPER"],

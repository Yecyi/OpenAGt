...
function ClaudeInChromeMenu(t0) {
  ...
  if (
    ...
    t9 = !isDisabled && (
      <>
        ...
        <Select key={selectKey} options={options} onChange={handleAction} hideIndexes={true} />
        {showInstallHint && <Text color="warning">Once installed, select {'"Reconnect extension"'} to connect.</Text>}
        <Text>
  ...
  if ($[38] !== t11 || $[39] !== t5) {
    t12 = (
      <Dialog title="Claude in Chrome (Beta)" onCancel={t5} color="chromeYellow">
        {t11}
      </Dialog>
    )
    $[38] = t11

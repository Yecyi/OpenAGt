  ...
  return (
    <Box flexDirection="column">
      ...
      {visiblePlugins.map((plugin_5, visibleIndex) => {
        ...
        return (
          <Box
            key={`${pagination.startIndex}-${plugin_5.pluginId}`}
          ...
          >
            ...
            {plugin_5.entry.description && (
              <Box marginLeft={4}>
                <Text dimColor>{truncateToWidth(plugin_5.entry.description, 60)}</Text>
              </Box>
            )}
          </Box>
        )
  ...
  switch (reason) {
      ...
      if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = (
          <>
            ...
            <Text dimColor={true}>Please install git and restart Claude Code.</Text>
          </>
        )
        $[0] = t1
      } else {
    ...
    case "all-blocked-by-policy": {
      ...
      if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = (
          <>
            <Text dimColor={true}>Your organization policy does not allow any external marketplaces.</Text>

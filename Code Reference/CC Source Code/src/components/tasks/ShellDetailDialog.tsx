...
export function ShellDetailDialog(t0) {
  ...
  if ($[48] !== handleClose || $[49] !== t10 || $[50] !== t21 || $[51] !== t24 || $[52] !== t9) {
    t25 = (
      <Dialog title={t9} onCancel={handleClose} color="background" inputGuide={t10}>
        {t21}
        {t24}
      </Dialog>
    )
...
function ShellOutputContent(t0) {
  ...
  if ($[7] !== t1 || $[8] !== t2) {
    t3 = (
      <Box borderStyle="round" paddingX={1} flexDirection="column" height={12} maxWidth={t1}>
        {t2}
      </Box>
    )
    $[7] = t1

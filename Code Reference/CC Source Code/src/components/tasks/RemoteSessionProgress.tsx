    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
      t1 = (
        <>
          ...
          <Text dimColor={true}> ready · shift+↓ to view</Text>
        </>
      )
      $[0] = t1
    } else {
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
      t1 = (
        <>
          <Text color="background">{DIAMOND_FILLED} </Text>
          <RainbowText text="ultrareview" phase={0} />
          <Text color="error" dimColor={true}>
            {" \xB7 "}error
          </Text>
        </>
      )
...
export function RemoteSessionProgress(t0) {
  ...
  if (session.status === "completed") {
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
      t1 = (
        <Text bold={true} color="success" dimColor={true}>
          done
        </Text>
      )
      $[2] = t1
  ...
  if (session.status === "failed") {
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
      t1 = (
        <Text bold={true} color="error" dimColor={true}>
          error
        </Text>
      )
      $[3] = t1

...
export function InProcessTeammateDetailDialog(t0) {
    ...
    t16 = (exitState) =>
      exitState.pending ? (
        ...
        <Byline>
          ...
          {teammate.status === "running" && onForeground && <KeyboardShortcutHint shortcut="f" action="foreground" />}
        </Byline>
      )
    $[37] = onBack
    $[38] = onForeground
  ...
  if (
    ...
    t21 = (
      <Dialog title={title} subtitle={subtitle} onCancel={onDone} color="background" inputGuide={t16}>
        {t17}
        {t19}
        {t20}
      </Dialog>

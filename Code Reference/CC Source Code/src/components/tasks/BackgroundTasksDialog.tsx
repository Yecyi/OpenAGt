      ...
      case "monitor_mcp":
        ...
        return (
          <MonitorMcpDetailDialog
            task={task_0}
            onKill={
              task_0.status === "running" && killMonitorMcp ? () => killMonitorMcp(task_0.id, setAppState) : undefined
            }
            onBack={goBackToList}
              ...
              <Box flexDirection="column" marginTop={teammateTasks.length > 0 ? 1 : 0}>
                ...
                <Box flexDirection="column">
                  {bashTasks.map((item_6) => (
                    <Item key={item_6.id} item={item_6} isSelected={item_6.id === currentSelection?.id} />
                  ))}
                </Box>
              </Box>
            )}
              ...
              <Box flexDirection="column" marginTop={teammateTasks.length > 0 || bashTasks.length > 0 ? 1 : 0}>
                ...
                <Box flexDirection="column">
                  {mcpMonitors.map((item_7) => (
                    <Item key={item_7.id} item={item_7} isSelected={item_7.id === currentSelection?.id} />
                  ))}
                </Box>
              </Box>
            )}
              ...
              >
                ...
                <Box flexDirection="column">
                  {remoteSessions.map((item_8) => (
                    <Item key={item_8.id} item={item_8} isSelected={item_8.id === currentSelection?.id} />
                  ))}
                </Box>
              </Box>
            )}
              ...
              >
                ...
                <Box flexDirection="column">
                  {agentTasks.map((item_9) => (
                    <Item key={item_9.id} item={item_9} isSelected={item_9.id === currentSelection?.id} />
                  ))}
                </Box>
              </Box>
            )}
              ...
              >
                ...
                <Box flexDirection="column">
                  {workflowTasks.map((item_10) => (
                    <Item key={item_10.id} item={item_10} isSelected={item_10.id === currentSelection?.id} />
                  ))}
                </Box>
              </Box>
            )}
              ...
              >
                <Box flexDirection="column">
                  {dreamTasks_0.map((item_11) => (
                    <Item key={item_11.id} item={item_11} isSelected={item_11.id === currentSelection?.id} />
                  ))}
                </Box>
              </Box>
            )}
        ...
        {teamEntries.map((t2) => {
          ...
          return (
            <Box key={teamName_0} flexDirection="column">
              <Text dimColor={true}>
                {"  "}Team: {teamName_0} ({memberCount})
              </Text>
              {leaderItems.map((item_0) => (
                <Item key={`${item_0.id}-${teamName_0}`} item={item_0} isSelected={item_0.id === currentSelectionId} />
              ))}
              {items.map((item_1) => (

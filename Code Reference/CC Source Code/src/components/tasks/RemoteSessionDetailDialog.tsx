...
function UltraplanSessionDetail(t0) {
  ...
  if (confirmingStop) {
    ...
    if ($[15] !== goBackOrClose || $[16] !== onKill) {
      t10 = (
        <Dialog title="Stop ultraplan?" onCancel={t6} color="background">
  ...
  if (
    ...
    t15 = (
      <Text>
        {t11}
        {agentsWorking} {t12} {t13} · {toolCalls} tool {t14}
      </Text>
    )
    $[33] = agentsWorking
    $[34] = t11
  ...
  if ($[66] !== goBackOrClose || $[67] !== t10 || $[68] !== t25) {
    t26 = (
      <Dialog title={t10} onCancel={goBackOrClose} color="background">
        {t25}
      </Dialog>
    )
    $[66] = goBackOrClose
...
function ReviewSessionDetail(t0) {
  ...
  if (confirmingStop) {
    ...
    if ($[8] !== goBackOrClose || $[9] !== onKill) {
      t7 = (
        <Dialog title="Stop ultrareview?" onCancel={t3} color="background">
          <Box flexDirection="column" gap={1}>
            {t4}
            <Select
              options={t6}
  ...
  if ($[52] !== goBackOrClose || $[53] !== t19 || $[54] !== t9) {
    t20 = (
      <Dialog title={t9} onCancel={goBackOrClose} color="background" inputGuide={_temp}>
        {t19}
      </Dialog>
    )
    $[52] = goBackOrClose

...
export function SelectMatcherMode(t0) {
  ...
  if (matchersForSelectedEvent.length === 0) {
    ...
    if ($[8] !== eventDescription || $[9] !== onCancel || $[10] !== t2) {
      t4 = (
        <Dialog title={t2} subtitle={eventDescription} onCancel={onCancel} inputGuide={_temp2}>
          {t3}
        </Dialog>
      )
      $[8] = eventDescription
  ...
  if ($[16] !== onCancel || $[17] !== t3 || $[18] !== t4) {
    t5 = (
      <Box flexDirection="column">
        <Select options={t3} onChange={t4} onCancel={onCancel} />
      </Box>
    )
    $[16] = onCancel
    $[17] = t3
  ...
  if ($[20] !== eventDescription || $[21] !== onCancel || $[22] !== t2 || $[23] !== t5) {
    t6 = (
      <Dialog title={t2} subtitle={eventDescription} onCancel={onCancel}>
        {t5}
      </Dialog>
    )
    $[20] = eventDescription

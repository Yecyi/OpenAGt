    ...
    t1 = (
      <MessageResponse>
        <Box flexDirection="column">
          ...
          {isKeychainLocked && <Text dimColor={true}>· Run in another terminal: security unlock-keychain</Text>}
        </Box>
      </MessageResponse>
    )
    $[1] = t1
      ...
      if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = (
          <MessageResponse height={1}>
            <Text color="error">
              Context limit reached · /compact or /clear to continue{upgradeHint ? ` · ${upgradeHint}` : ""}
            </Text>
          </MessageResponse>
        )
        $[4] = t3

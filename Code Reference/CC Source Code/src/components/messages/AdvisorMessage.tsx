...
export function AdvisorMessage(t0) {
  const $ = _c(30)
  const { block, addMargin, resolvedToolUseIDs, erroredToolUseIDs, shouldAnimate, verbose, advisorModel } = t0
  if (block.type === "server_tool_use") {
    ...
    if ($[17] !== t2 || $[18] !== t6 || $[19] !== t8 || $[20] !== t9) {
      t10 = (
        <Box marginTop={t2} paddingRight={2} flexDirection="row">
          {t6}
          {t7}
          {t8}
          {t9}
  ...
  bb0: switch (block.content.type) {
    ...
    case "advisor_redacted_result": {
      ...
      if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = (
          <Text dimColor={true}>{figures.tick} Advisor has reviewed the conversation and will apply the feedback</Text>
        )
        $[27] = t1
      } else {
        t1 = $[27]

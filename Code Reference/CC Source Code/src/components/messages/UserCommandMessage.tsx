...
export function UserCommandMessage(t0) {
  ...
  if (isSkillFormat) {
    ...
    if ($[7] !== t4 || $[8] !== t6) {
      t7 = (
        <Box flexDirection="column" marginTop={t4} backgroundColor="userMessageBackground" paddingRight={1}>
          {t6}
        </Box>
      )
      $[7] = t4
  ...
  if ($[16] !== t5 || $[17] !== t7) {
    t8 = (
      <Box flexDirection="column" marginTop={t5} backgroundColor="userMessageBackground" paddingRight={1}>
        {t7}
      </Box>
    )
    $[16] = t5

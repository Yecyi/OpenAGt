              ...
              return (
                <Box key={String(option_1.value)} flexDirection="column" flexShrink={0}>
                  ...
                  {option_1.description && (
                    <Box paddingLeft={2}>
                      <Text dimColor={isOptionDisabled || option_1.dimDescription !== false} color={optionColor}>
            ...
            {state.visibleOptions.map((option_2, index_1) => {
              ...
              return (
                <Box key={String(option_2.value)} flexDirection="column" flexShrink={0}>
                  ...
                  >
                    <>
                      {!hideIndexes && <Text dimColor={true}>{`${i_0}.`.padEnd(maxIndexWidth_0 + 1)}</Text>}
                      <Text
            ...
            return (
              <TwoColumnRow key={String(data_0.option.value)} isFocused={data_0.isFocused}>
                <Box flexDirection="row" flexShrink={0}>
                  ...
                  >
                    {!hideIndexes && <Text dimColor={true}>{`${data_0.index}.`.padEnd(maxIndexWidth_1 + 2)}</Text>}
                    {data_0.label}
                  </Text>
          ...
          >
            <Box flexDirection="row" flexShrink={0}>
              ...
              <Text
                ...
                color={
                  isOptionDisabled_2 ? undefined : isSelected_3 ? "success" : isFocused_3 ? "suggestion" : undefined
                }
              >
                {label_2}

...
function GracePeriodContentBody() {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = (
      <Text>
        An update to our Consumer Terms and Privacy Policy will take effect on <Text bold={true}>October 8, 2025</Text>.
      ...
      <Box paddingLeft={1}>
        <Text>
          ...
          <Text>
            ...
            in your Privacy Settings (<Link url="https://claude.ai/settings/data-privacy-controls" />
            ).
          </Text>
        </Text>
      </Box>
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = (
      <>
        ...
        {t5}
        <Text>
          Learn more ({t6}) or read the updated Consumer Terms ({t7}) and Privacy Policy (
          <Link url="https://anthropic.com/legal/privacy" />)
        </Text>
      </>
    )
    $[8] = t8
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = (
      <Box flexDirection="column">
        ...
        <Text>
          Allow the use of your chats and coding sessions to train and improve Anthropic AI models. You can change this
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = (
      <>
        ...
        {t3}
        <Text>
          Learn more ({t4}) or read the updated Consumer Terms ({t5}) and Privacy Policy (
          <Link url="https://anthropic.com/legal/privacy" />)
        </Text>
      </>
    )
...
export function PrivacySettingsDialog(t0) {
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = (
      <Text>
        Review and manage your privacy settings at <Link url="https://claude.ai/settings/data-privacy-controls" />
      </Text>
    )
    $[9] = t5
  } else {
  ...
  if ($[13] !== onDone || $[14] !== t4 || $[15] !== t7) {
    t8 = (
      <Dialog title="Data Privacy" color="professionalBlue" onCancel={onDone} inputGuide={t4}>
        {t5}
        {t7}
      </Dialog>
    )

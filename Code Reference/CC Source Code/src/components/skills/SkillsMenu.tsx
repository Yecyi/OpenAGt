...
export function SkillsMenu(t0) {
  ...
  if (skills.length === 0) {
    ...
    if ($[8] !== handleCancel) {
      t5 = (
        <Dialog title="Skills" subtitle="No skills found" onCancel={handleCancel} hideInputGuide={true}>
          {t3}
          {t4}
        </Dialog>
      )
  ...
  if ($[31] !== handleCancel || $[32] !== t12 || $[33] !== t6) {
    t14 = (
      <Dialog title="Skills" subtitle={t6} onCancel={handleCancel} hideInputGuide={true}>
        {t12}
        {t13}
      </Dialog>
    )

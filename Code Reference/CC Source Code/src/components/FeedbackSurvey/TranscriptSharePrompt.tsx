...
export function TranscriptSharePrompt(t0) {
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = (
      <Box>
        ...
        <Text bold={true}>Can Anthropic look at your session transcript to help us improve Claude Code?</Text>
      </Box>
    )
    $[6] = t3
  } else {
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = (
      <Box marginLeft={2}>
        <Text dimColor={true}>Learn more: https://code.claude.com/docs/en/data-usage#session-quality-surveys</Text>
      </Box>
    )
    $[7] = t4
  } else {

      ...
      t1 = (
        <Box flexDirection="column">
          ...
          {rules.length > 0 && (
            <Box flexDirection="row">
              <Box justifyContent="flex-end" minWidth={width}>
                <Text dimColor={true}> Rules </Text>
              </Box>
              <Box flexDirection="column">{rules.map(_temp2)}</Box>
            </Box>
          )}
          {directories.length > 0 && (
            <Box flexDirection="row">
              <Box justifyContent="flex-end" minWidth={width}>
                <Text dimColor={true}> Directories </Text>
              </Box>
              <Box flexDirection="column">{directories.map(_temp3)}</Box>
            </Box>
          )}
          {mode && (
            <Box flexDirection="row">
              <Box justifyContent="flex-end" minWidth={width}>
                <Text dimColor={true}> Mode </Text>
              </Box>
...
export function PermissionDecisionDebugInfo(t0) {
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = (
      <Box justifyContent="flex-end" minWidth={10}>
        <Text dimColor={true}>Behavior </Text>
      </Box>
    )
    $[6] = t2
  } else {
  ...
  if ($[9] !== permissionResult.behavior || $[10] !== permissionResult.message) {
    t4 = permissionResult.behavior !== "allow" && (
      <Box flexDirection="row">
        <Box justifyContent="flex-end" minWidth={10}>
  ...
  if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = (
      <Box justifyContent="flex-end" minWidth={10}>
        <Text dimColor={true}>Reason </Text>
      </Box>
    )
    $[12] = t5
  } else {

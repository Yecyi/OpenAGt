...
export function WorkspaceTab(t0) {
  const $ = _c(23)
  const { onExit, toolPermissionContext, onRequestAddDirectory, onRequestRemoveDirectory, onHeaderFocusChange } = t0
  ...
  if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = (
      <Box flexDirection="row" marginTop={1} marginLeft={2} gap={1}>
        ...
        <Text dimColor={true}>(Original working directory)</Text>
      </Box>
    )
    $[15] = t6
  } else {

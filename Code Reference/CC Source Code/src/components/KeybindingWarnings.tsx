    ...
    bb0: {
      ...
      t0 = (
        <Box flexDirection="column" marginTop={1} marginBottom={1}>
          <Text bold={true} color={errors.length > 0 ? "error" : "warning"}>
...
function _temp4(warning, i_0) {
  return (
    <Box key={`warning-${i_0}`} flexDirection="column">
      <Box>
      ...
      {warning.suggestion && (
        <Box marginLeft={3}>
          <Text dimColor={true}>→ {warning.suggestion}</Text>
        </Box>
      )}
    </Box>
  )
...
function _temp3(error, i) {
  return (
    <Box key={`error-${i}`} flexDirection="column">
      ...
      {error.suggestion && (
        <Box marginLeft={3}>
          <Text dimColor={true}>→ {error.suggestion}</Text>
        </Box>
      )}
    </Box>
  )

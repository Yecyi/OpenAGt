...
export function AgentsList(t0) {
    ...
    bb1: {
      ...
      if (hasNoAgents) {
        ...
        if ($[69] !== onBack || $[70] !== sourceTitle || $[71] !== t28) {
          t29 = (
            <Dialog title={sourceTitle} subtitle="No agents found" onCancel={onBack} hideInputGuide={true}>
              {t28}
            </Dialog>
          )
          $[69] = onBack
  ...
  if (
    ...
    t23 = (
      <T0 flexDirection={t11} tabIndex={t12} autoFocus={t13} onKeyDown={t14}>
        {t15}
        {t16}
      </T0>
    )

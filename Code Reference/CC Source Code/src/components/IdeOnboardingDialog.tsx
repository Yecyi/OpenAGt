...
export function IdeOnboardingDialog(t0) {
  ...
  if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = (
      <Text>
        • Claude has context of {t8} and <Text color="suggestion">⧉ selected lines</Text>
      </Text>
    )
    $[11] = t9
  } else {
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = (
      <Text>
        • Review Claude Code's changes {t10} <Text color="diffRemovedWord">-22</Text> in the comfort of your IDE
      </Text>
    )
    $[13] = t11
  } else {
  ...
  if ($[16] !== onDone || $[17] !== t6 || $[18] !== t7) {
    t14 = (
      <Dialog title={t6} subtitle={t7} color="ide" onCancel={onDone} hideInputGuide={true}>
        {t13}
      </Dialog>
    )
    $[16] = onDone

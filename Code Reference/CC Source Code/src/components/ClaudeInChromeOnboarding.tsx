...
export function ClaudeInChromeOnboarding(t0) {
  ...
  if ($[6] !== t4) {
    t5 = (
      <Text>
        Claude in Chrome works with the Chrome extension to let you control your browser directly from Claude Code. You
  ...
  if ($[10] !== t6) {
    t7 = (
      <Text dimColor={true}>
        ...
        settings to control which sites Claude can browse, click, and type on{t6}.
      </Text>
    )
    $[10] = t6
    $[11] = t7

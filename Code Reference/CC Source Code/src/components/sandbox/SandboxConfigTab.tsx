    ...
    t1 = (
      <Box flexDirection="column" paddingY={1}>
        <Box flexDirection="column">
          ...
          <Text dimColor={true}>{excludedCommands.length > 0 ? excludedCommands.join(", ") : "None"}</Text>
        </Box>
        {fsReadConfig.denyOnly.length > 0 && (
          <Box marginTop={1} flexDirection="column">
            ...
            {fsReadConfig.allowWithinDeny && fsReadConfig.allowWithinDeny.length > 0 && (
              <Text dimColor={true}>Allowed within denied: {fsReadConfig.allowWithinDeny.join(", ")}</Text>
            )}
          </Box>
        )}
        {fsWriteConfig.allowOnly.length > 0 && (
          <Box marginTop={1} flexDirection="column">
            ...
            {fsWriteConfig.denyWithinAllow.length > 0 && (
              <Text dimColor={true}>Denied within allowed: {fsWriteConfig.denyWithinAllow.join(", ")}</Text>
            )}
          </Box>
        )}

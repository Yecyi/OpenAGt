...
function OverridesSelect(t0) {
  const $ = _c(25)
  const { onComplete, currentMode } = t0
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = (
      <Text dimColor={true}>
        ...
        When a command fails due to sandbox restrictions, Claude can retry with dangerouslyDisableSandbox to run outside
        the sandbox (falling back to default permissions).
      </Text>
    )
    $[20] = t11
  } else {

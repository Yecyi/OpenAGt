        ...
        <>
          ...
          <Box flexDirection="column">
            <Text>
              ...
              {seccompMissing && <Text dimColor={true}> (required to block unix domain sockets)</Text>}
            </Text>
            {seccompMissing && (
              <Box flexDirection="column">
                <Text dimColor={true}>{"  "}· npm install -g @anthropic-ai/sandbox-runtime</Text>
                <Text dimColor={true}>{"  "}· or copy vendor/seccomp/* from sandbox-runtime and set</Text>
                <Text dimColor={true}>{"    "}sandbox.seccomp.bpfPath and applyPath in settings.json</Text>
              </Box>
            )}
          </Box>
        </>

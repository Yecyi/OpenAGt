...
- **The "Rule" Component:** While we avoid sectioning lines, a single, ultra-thin (0.5pt) horizontal line using `outline-variant` at 50% opacity can be used _within_ an article to separate the "Lede" from the "Body," mimicking traditional newspaper layouts.
